...
class GUI:
    #Here, we do designing components of board, variables calling and initializing...
    pieces = {}
    selected_piece = None
    focused = None
    images = {}
...
# Here we use main function for execution of all functions and variables used in this project...
def main(chessboard):
    root = tk.Tk()
    root.title("Chess")
...
# Here we call main function for execution...
