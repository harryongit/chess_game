...
class Board(dict):
    #Here, we do Board components variables calling and initializing...
    ...
    fullmove_number = 1
    history = []
    #Here, we follow the chess rule and give command to every pieces in chess using python functions...
...
#Here, we do chess game rule error follow, by using python exception handling...
